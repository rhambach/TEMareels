"""
   ...
   USAGE
     ...
     The angular correction function for w-q mapping can be 
...
class TEM_wqslit(Aperture):
  ...
  def __init__(self,q0,dqx,dqy,E0,verbosity=0):
    """
      q0 ... center of aperture [a.u. = 1/bohr]
     dqx ... width of aperture along x-direction [a.u. = 1/bohr]
     dqy ... height of aperture along y-direction (dispersive direction) [a.u. = 1/bohr]
      E0 ... beam energy [keV]
    """
    self.q0 = q0;
    self.dqx= dqx;
